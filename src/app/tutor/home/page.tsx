    ...
    <div className="min-h-screen bg-[#F5F6FA]">
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl font-semibold text-base flex items-center justify-center gap-2 border-[1.5px] border-[#0259EF] text-[#0259EF] bg-white mb-4"
        >
